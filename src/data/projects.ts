...
export const projects: Project[] = [
  ...
  },
  {
    ...
    lang: "EN",
    caseType: "Real case",
    oneLiner: "10-year DCF valuation and leveraged investment analysis of an upper-midscale London hotel asset for a Private Equity Real Estate Fund.",
    featured: true,
    ...
    cardBullets: [
      ...
      "Assessed leveraged returns across multiple LTV structures against PEREF return thresholds",
    ],
    cardDeliverable: "Public case summary and methodology snapshot",
    ...
    confidentialityNote: "This project was completed in an academic setting using proprietary and licensed data provided for coursework only. Publicly shared content has been anonymized and summarized to comply with data-sharing restrictions.",
    context: "Term project for the Real Estate Finance course at EHL (Fall 2025). Worked in a team of 6 as the investment analyst team of a Private Equity Real Estate Fund (PEREF), tasked with evaluating the acquisition of an upper-midscale London hotel asset in a central urban submarket.",
    objective: "Estimate the market value of the hotel via a 10-year DCF and assess whether the leveraged acquisition meets the PEREF\u2019s minimum total return target across multiple leverage scenarios.",
    contribution: [
      "Built the core Excel financial model supporting the entire analysis",
      "Developed the preliminary underwriting and market assumption analysis (cap rate estimation, ADR growth rate, market statistics)",
      "Built the property-level 10-year DCF valuation module with property-specific cash flow projections",
      "Contributed to the leveraged return scenario analysis and investment recommendation",
    ],
    method: [
      ...
      "Investment analysis: leveraged before-tax IRR, M-IRR, and NPV across multiple LTV scenarios benchmarked against PEREF return thresholds",
    ],
    deliverables: [],
    results: [
      "The DCF indicated a valuation outcome above the negotiated purchase price, but the investment still did not meet the fund\u2019s required return threshold",
      "Unlevered returns were below the fund\u2019s minimum target even before financing costs",
      "Higher leverage scenarios consistently reduced equity returns, illustrating a negative leverage effect as borrowing costs exceeded the asset\u2019s unlevered yield",
      "Recommendation: do not acquire under the fund\u2019s return requirements; the asset\u2019s stable income profile appeared better suited to a lower-return, core-oriented investor",
    ],
    whyItMatters: [
    ...
    seoDescription: "How I structured a hotel acquisition analysis for a PE fund: 10-year DCF, cap rate estimation, and leveraged return scenarios across multiple LTV structures.",
  ...
  // ── Secondary Projects ──
  {
    ...
    lang: "EN",
    caseType: "Real case",
    oneLiner: "Strategy Challenge for Badrutt\u2019s Palace Hotel (St. Moritz), developing a season-extension concept to improve profitability during the shoulder period.",
    featured: false,
    ...
    cardBullets: [
      ...
      "Contributed to a data-driven deliverable with positioning, feasibility analysis, and implementation logic",
    ],
    cardDeliverable: "Strategic recommendation deliverable with positioning, KPIs, and implementation roadmap",
    tags: ["Desk Research", "Strategic Analysis", "Problem Framing", "Option Evaluation", "Client Communication", "Presentation", "Luxury Hospitality"],
    confidentialityNote: "This project was completed under an NDA in an academic consulting setting. Publicly shared content is limited to a high-level summary of my role, methodology, and non-confidential learnings.",
    context: "Multi-week Strategy Challenge for the Corporate Strategy course at EHL (Spring 2025). Worked in a team as consultants for a world-renowned luxury alpine hotel in Switzerland. The hotel operates seasonally and faces significant fixed costs during closure periods, creating a strategic opportunity to extend the operating season and improve profitability.",
    objective: "Develop a sound, convincing, and realistic strategic recommendation to extend the operating season and improve profitability, while preserving the hotel\u2019s brand positioning and service standards.",
    contribution: [
      "Helped shape the core strategic idea submitted by the team, focused on a differentiated positioning for the shoulder season",
      "Conducted desk research to support and justify the proposal with credible sources (market data, target segment trends, competitive landscape)",
    ...
    method: [
      "Situation and stakeholder analysis: assessed the hotel\u2019s seasonal economics, guest segments, and destination demand patterns to identify the strategic opportunity",
      "Option generation and evaluation: benchmarked competitors, identified a positioning gap in the luxury alpine market, and evaluated options against impact, feasibility, and strategic fit criteria",
      "Recommendation and implementation: structured a commercially oriented recommendation framework with customer segmentation, operational feasibility, and risk mitigation considerations",
    ],
    deliverables: [],
    results: [
      "Developed a differentiated off-season demand-generation concept for a luxury alpine hotel",
      "Built a strategy grounded in market positioning, customer segmentation, and operational feasibility",
      "Structured a commercially oriented recommendation framework to support management decision-making",
      "Focused on brand consistency, execution practicality, and risk-aware implementation",
    ],
    whyItMatters: [
      "Real consulting engagement with a world-renowned luxury alpine hotel",
      "Strategy work grounded in market research and operational feasibility, not just theory",
    ...
    skills: ["Strategic Analysis", "Desk Research", "Competitive Benchmarking", "Client Communication", "Problem Framing", "Option Evaluation", "Market Research"],
    tools: ["PowerPoint", "Excel", "Canva"],
    keywords: ["corporate strategy", "season extension", "luxury hospitality", "strategic recommendation", "competitive analysis", "management consulting", "business strategy", "stakeholder management", "market research", "feasibility", "positioning", "implementation"],
    seoTitle: "Corporate Strategy \u2013 Luxury Hotel Season Extension | Alexandre Carboni",
    seoDescription: "How I developed a season-extension strategy for Badrutt\u2019s Palace Hotel (St. Moritz): market positioning, feasibility analysis, and strategic recommendation.",
